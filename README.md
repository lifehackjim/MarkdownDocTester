...
optional arguments:
  ...
  -o OUTDIR, --outdir OUTDIR
                        ...
                        (default: /tmp/2014_04_30-23_12_20)
...
```
87080866        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:12 /tmp/foo
87081072        8 -rw-r--r--    1 jolsen           wheel                  15 Apr 30 23:12 /tmp/foo/test
...
```
87080866        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:12 /tmp/foo
87081072        8 -rw-r--r--    1 jolsen           wheel                  30 Apr 30 23:12 /tmp/foo/test
87080867        0 -rw-r--r--    1 jolsen           wheel                   0 Apr 30 23:10 /tmp/foo/test.json
```
...
```
87080866        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:12 /tmp/foo
87081072        8 -rw-r--r--    1 jolsen           wheel                  45 Apr 30 23:12 /tmp/foo/test
87080867        0 -rw-r--r--    1 jolsen           wheel                   0 Apr 30 23:10 /tmp/foo/test.json
```
...
```
87081073        0 drwxr-xr-x    3 jolsen           wheel                 102 Apr 30 23:12 /tmp/foo
87081074        8 -rw-r--r--    1 jolsen           wheel                  15 Apr 30 23:12 /tmp/foo/test
```
...
```
87081075        0 drwxr-xr-x    3 jolsen           wheel                 102 Apr 30 23:12 /tmp/foo
...
/tmp/foo:
total 0
-rw-r--r--  1 jolsen  wheel  0 Apr 30 23:12 test.json
```
...
###### generated by: `md_doctester v1.4.3`, date: Wed Apr 30 23:12:20 2014 EDT, Contact info: **Jim Olsen <jim.olsen@lifehack.com>**