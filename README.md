...
optional arguments:
  ...
  -o OUTDIR, --outdir OUTDIR
                        ...
                        (default: /tmp/2014_04_30-23_15_11)
...
```
87081075        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:15 /tmp/foo
87081333        8 -rw-r--r--    1 jolsen           wheel                  15 Apr 30 23:15 /tmp/foo/test
87081076        0 -rw-r--r--    1 jolsen           wheel                   0 Apr 30 23:12 /tmp/foo/test.json
```
...
```
87081075        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:15 /tmp/foo
87081333        8 -rw-r--r--    1 jolsen           wheel                  30 Apr 30 23:15 /tmp/foo/test
87081076        0 -rw-r--r--    1 jolsen           wheel                   0 Apr 30 23:12 /tmp/foo/test.json
```
...
```
87081075        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:15 /tmp/foo
87081333        8 -rw-r--r--    1 jolsen           wheel                  45 Apr 30 23:15 /tmp/foo/test
87081076        0 -rw-r--r--    1 jolsen           wheel                   0 Apr 30 23:12 /tmp/foo/test.json
```
...
```
87081334        0 drwxr-xr-x    3 jolsen           wheel                 102 Apr 30 23:15 /tmp/foo
87081335        8 -rw-r--r--    1 jolsen           wheel                  15 Apr 30 23:15 /tmp/foo/test
```
...
```
87081336        0 drwxr-xr-x    3 jolsen           wheel                 102 Apr 30 23:15 /tmp/foo
...
/tmp/foo:
total 8
-rw-r--r--  1 jolsen  wheel  18 Apr 30 23:15 test.json
```
...
###### generated by: `md_doctester v1.4.3`, date: Wed Apr 30 23:15:11 2014 EDT, Contact info: **Jim Olsen <jim.olsen@lifehack.com>**