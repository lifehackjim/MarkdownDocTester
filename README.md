...
optional arguments:
  ...
  -o OUTDIR, --outdir OUTDIR
                        ...
                        (default: /tmp/2014_04_30-23_24_15)
...
```
87081713        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:24 /tmp/foo
87081976        8 -rw-r--r--    1 jolsen           wheel                  15 Apr 30 23:24 /tmp/foo/test
87081714        8 -rw-r--r--    1 jolsen           wheel                  18 Apr 30 23:21 /tmp/foo/test.json
```
...
```
87081713        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:24 /tmp/foo
87081976        8 -rw-r--r--    1 jolsen           wheel                  30 Apr 30 23:24 /tmp/foo/test
87081714        8 -rw-r--r--    1 jolsen           wheel                  18 Apr 30 23:21 /tmp/foo/test.json
```
...
```
87081713        0 drwxr-xr-x    4 jolsen           wheel                 136 Apr 30 23:24 /tmp/foo
87081976        8 -rw-r--r--    1 jolsen           wheel                  45 Apr 30 23:24 /tmp/foo/test
87081714        8 -rw-r--r--    1 jolsen           wheel                  18 Apr 30 23:21 /tmp/foo/test.json
```
...
```
87081977        0 drwxr-xr-x    3 jolsen           wheel                 102 Apr 30 23:24 /tmp/foo
87081978        8 -rw-r--r--    1 jolsen           wheel                  15 Apr 30 23:24 /tmp/foo/test
```
...
```
87081979        0 drwxr-xr-x    3 jolsen           wheel                 102 Apr 30 23:24 /tmp/foo
87081980        8 -rw-r--r--    1 jolsen           wheel                  18 Apr 30 23:24 /tmp/foo/test.json
```
...
/tmp/foo:
total 8
-rw-r--r--  1 jolsen  wheel  18 Apr 30 23:24 test.json
```
...
###### generated by: `md_doctester v1.4.3`, date: Wed Apr 30 23:24:15 2014 EDT, Contact info: **Jim Olsen <jim.olsen@lifehack.com>**