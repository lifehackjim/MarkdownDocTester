...
optional arguments:
  ...
  -o OUTDIR, --outdir OUTDIR
                        ...
                        (default: /tmp/2014_05_02-08_10_21)
...
```
87167418        0 drwxr-xr-x    4 jolsen           wheel                 136 May  2 08:10 /tmp/foo
87167425        8 -rw-r--r--    1 jolsen           wheel                  15 May  2 08:10 /tmp/foo/test
87167419        8 -rw-r--r--    1 jolsen           wheel                  19 May  2 08:10 /tmp/foo/test.json
```
...
```
87167418        0 drwxr-xr-x    4 jolsen           wheel                 136 May  2 08:10 /tmp/foo
87167425        8 -rw-r--r--    1 jolsen           wheel                  30 May  2 08:10 /tmp/foo/test
87167419        8 -rw-r--r--    1 jolsen           wheel                  19 May  2 08:10 /tmp/foo/test.json
```
...
```
87167418        0 drwxr-xr-x    4 jolsen           wheel                 136 May  2 08:10 /tmp/foo
87167425        8 -rw-r--r--    1 jolsen           wheel                  45 May  2 08:10 /tmp/foo/test
87167419        8 -rw-r--r--    1 jolsen           wheel                  19 May  2 08:10 /tmp/foo/test.json
```
...
```
87167426        0 drwxr-xr-x    3 jolsen           wheel                 102 May  2 08:10 /tmp/foo
87167427        8 -rw-r--r--    1 jolsen           wheel                  15 May  2 08:10 /tmp/foo/test
```
...
```
87167428        0 drwxr-xr-x    3 jolsen           wheel                 102 May  2 08:10 /tmp/foo
87167429        8 -rw-r--r--    1 jolsen           wheel                  18 May  2 08:10 /tmp/foo/test.json
```
...
/tmp/foo:
total 8
-rw-r--r--  1 jolsen  wheel  19 May  2 08:10 test.json
```
...
###### generated by: `md_doctester v1.4.4`, date: Fri May  2 08:10:22 2014 EDT, Contact info: **Jim Olsen <jim@lifehack.com>**