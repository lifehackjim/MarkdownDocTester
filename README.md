...
optional arguments:
  ...
  -o OUTDIR, --outdir OUTDIR
                        ...
                        (default: /tmp/2014_05_02-07_59_53)
...
# Examples
  ...
  * See [example/build.sh](example/build.sh) for a script that will build markdown and HTML documentation for all *.ini files in examples/
...
```
87166501        0 drwxr-xr-x    4 jolsen           wheel                 136 May  2 07:59 /tmp/foo
87167027        8 -rw-r--r--    1 jolsen           wheel                  15 May  2 07:59 /tmp/foo/test
87166502        8 -rw-r--r--    1 jolsen           wheel                  19 May  2 07:52 /tmp/foo/test.json
```
...
```
87166501        0 drwxr-xr-x    4 jolsen           wheel                 136 May  2 07:59 /tmp/foo
87167027        8 -rw-r--r--    1 jolsen           wheel                  30 May  2 07:59 /tmp/foo/test
87166502        8 -rw-r--r--    1 jolsen           wheel                  19 May  2 07:52 /tmp/foo/test.json
```
...
```
87166501        0 drwxr-xr-x    4 jolsen           wheel                 136 May  2 07:59 /tmp/foo
87167027        8 -rw-r--r--    1 jolsen           wheel                  45 May  2 07:59 /tmp/foo/test
87166502        8 -rw-r--r--    1 jolsen           wheel                  19 May  2 07:52 /tmp/foo/test.json
```
...
```
87167028        0 drwxr-xr-x    3 jolsen           wheel                 102 May  2 07:59 /tmp/foo
87167029        8 -rw-r--r--    1 jolsen           wheel                  15 May  2 07:59 /tmp/foo/test
```
...
```
87167030        0 drwxr-xr-x    3 jolsen           wheel                 102 May  2 07:59 /tmp/foo
87167031        8 -rw-r--r--    1 jolsen           wheel                  18 May  2 07:59 /tmp/foo/test.json
```
...
/tmp/foo:
total 8
-rw-r--r--  1 jolsen  wheel  19 May  2 07:59 test.json
```
...
###### generated by: `md_doctester v1.4.4`, date: Fri May  2 07:59:53 2014 EDT, Contact info: **Jim Olsen <jim@lifehack.com>**